...
/**
 * Tests that the "Equinox system bundles have been added" flag is scoped to a single scan, rather than being held in
 * a static field that stays set for the lifetime of the JVM.
 */
public class ClasspathOrderEquinoxSystemBundlesTest {
    /**
     * Create a {@link ClasspathOrder}, as {@code ClasspathFinder} does once per scan.
     *
    ...
    public void systemBundlesAreAddedOnlyOncePerScan() {
        final ClasspathOrder classpathOrder = newClasspathOrder();
