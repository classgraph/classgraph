 ...
 * {@link Resource#openClassfile()} is package-private, so {@link Resource} can only be subclassed here.
 */
public class ClassfileReaderCloseTest {
    ...
    public void resourceIsClosedEvenIfClosingTheStreamFails() throws IOException {
        final RecordingResource resource = new RecordingResource();
        final ClassfileReader classfileReader = new ClassfileReader(new UncloseableInputStream(), resource);
