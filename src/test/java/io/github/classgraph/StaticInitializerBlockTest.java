...
public class StaticInitializerBlockTest {
    ...
    private static ScanResult scan() {
        return new ClassGraph().acceptClasses(HasStaticInitializer.class.getName()).enableMethodInfo()
    ...
    public void kindBasedQueriesExcludeStaticInitializer() {
        try (ScanResult scanResult = scan()) {
            final ClassInfo classInfo = scanResult.getClassInfo(HasStaticInitializer.class.getName());
