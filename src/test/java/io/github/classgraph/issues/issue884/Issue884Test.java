...
/**
 * A reject criterion containing a glob wildcard was not applied to the sub-packages of a matched package (#884).
 *
 * <p>
...
public class Issue884Test {
    ...
    public void globRejectPrefixIsApplied() {
        final AcceptRejectPrefix acceptReject = new AcceptRejectPrefix('.');
    ...
    public void globRejectIsRecursiveWhenEnumeratingFlatly() {
        try (ScanResult scanResult = new ClassGraph().enableSystemJarsAndModules().acceptPackages("javax.swing")
