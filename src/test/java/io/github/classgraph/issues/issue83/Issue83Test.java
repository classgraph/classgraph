...
public class Issue83Test {
    ...
    public void jarWhitelist() {
        ...
        new ClassGraph().overrideClasspath(jarPathURL).whitelistJars("nested-jars-level1.zip").scan()
    ...
    public void jarBlacklist() {
        ...
        new ClassGraph().overrideClasspath(jarPathURL).blacklistJars("nested-jars-level1.zip").scan()
                .getAllResources().forEach(res -> paths.add(res.getPath()));
