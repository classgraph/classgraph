...
public class Issue340Test {
    ...
    public void test() {
        ...
        try (var scanResult = new ClassGraph()
            ...
            // jar2 has a Class-Path entry that points to jar1; jar4 has a Class-Path entry
            // that points to jar3.
            // jar2 and jar4 also have an invalid Class-Path entry that tries to escape the
            // parent jar root.
