...
public class Issue916Test {
    /**
     * A plain, non-nested jar creates no temporary files, so nothing needs to be
     * closed to remove them.
     */
    @Test
    ...
    /**
     * Without the flag, resources were always readable -- pin that this is
     * unchanged.
     */
    @Test
