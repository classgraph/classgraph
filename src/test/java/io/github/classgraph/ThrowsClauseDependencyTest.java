...
/**
 * The exception types in a method's {@code throws} clause are dependencies of
 * the declaring class. For a generic method they are listed in the method's
 * type signature; for a non-generic method they are only recorded in the
 * {@code Exceptions} attribute of the method, which references the exception
 * classes through the constant pool, so they are also picked up as class
 * references while the constant pool is read.
 */
public class ThrowsClauseDependencyTest {
    ...
    /**
     * A class that references {@link ThrownException} only through a {@code throws}
     * clause.
     */
    public static class ClassWithThrowingMethod {
         ...
         *
         * @throws ThrownException never thrown
         */
    ...
    /**
     * The exception type in a {@code throws} clause is an inter-class dependency of
     * the declaring class.
     */
    @Test
