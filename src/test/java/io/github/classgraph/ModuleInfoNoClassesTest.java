 ...
 * {@code module-info.class} file, which does not itself contribute a {@link ClassInfo}. A {@link ModuleInfo} with no
 * accepted classes therefore has a null class set, which used to make {@link ModuleInfo#getClassInfo()} and
