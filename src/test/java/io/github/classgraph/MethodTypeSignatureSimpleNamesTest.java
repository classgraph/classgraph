...
public class MethodTypeSignatureSimpleNamesTest {
    ...
    public void resultTypeUsesSimpleName() throws ParseException {
        final MethodTypeSignature sig = MethodTypeSignature
                .parse("(Ljava/lang/String;)Ljava/util/Map;^Ljava/io/IOException;", /* definingClassName = */ null);
        assertThat(sig.toStringWithSimpleNames()).isEqualTo("Map (String) throws IOException");
        assertThat(sig.toString())
                .isEqualTo("java.util.Map (java.lang.String) throws java.io.IOException");
    }
}
