...
/**
 * A stand-in for Quarkus' {@code io.quarkus.bootstrap.runner.RunnerClassLoader}, used to test that
 * {@code QuarkusClassLoaderHandler} degrades gracefully when the fields it reads by reflection are not present
 * (Quarkus has renamed such fields between releases).
 *
 * <p>
