...
public class ClassInfoDescriptorNameTest {
    ...
    public void aDescriptorAndAClassNameNameTheSameClass() {
        final Map<String, ClassInfo> classNameToClassInfo = new HashMap<>();
        final var fromDescriptor = ClassInfo.getOrCreateClassInfo("Ljava/lang/String;", classNameToClassInfo);
        final var fromName = ClassInfo.getOrCreateClassInfo("java.lang.String", classNameToClassInfo);
