...
class TypeAnnotationTest {
    ...
    void typeAnnotations() {
        try (var scanResult = new ClassGraph().enableClasspath()
            ...
            final var arrField = classInfo.getFieldInfo("arr");
            ...
            final var comparableField = classInfo.getFieldInfo("comparable");
            ...
            final var inner1Field = classInfo.getFieldInfo("inner1");
            ...
            final var xyzField = classInfo.getFieldInfo("xyz");
            ...
            final var personClassInfo = scanResult.getClassInfo(Person.class.getName());

            final var emailsField = personClassInfo.getFieldInfo("emails");
            ...
            final var pClassInfo = scanResult.getClassInfo(P.class.getName());
